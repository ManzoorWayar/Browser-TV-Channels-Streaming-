...
import { afghanTvs } from '../assets/channels'
...
const AfghanTv = () => {
    ...
    return (
        <section>
            <h5 className="mt-5 mb-4">Afghan TVs</h5>
            <Slider {...settings} >
                {afghanTvs.map((channel) => (
                    <Link to='tv' key={channel.channel}>
                        <div className="items mx-3" onClick={getBlobUrl}>
                            <Image
                                className="m-auto"
                                src={channel.logo}
                                alt={channel.channel}
